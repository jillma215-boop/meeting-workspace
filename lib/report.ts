...
export type Report = {
  id: string; type: ReportType; startDate: string; endDate: string; status: ReportStatus; updatedAt: string;
...
export const createBlankReport = (type: ReportType = 'weekly'): Report => {
